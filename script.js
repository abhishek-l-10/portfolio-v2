    ...
    vocabularyContainer.innerHTML = `
      <div class="col-span-3">
        <div class="mt-4 text-center">
          ...
          <p class="mt-4 text-gray-500 bangla-font bangla-font">এই Lesson এ এখনো কোন Vocabulary যুক্ত করা হয়নি।</p>
        </div>
...
async function showWordDetails(id) {
  try {
    ...
    wordDetails.innerHTML = `
      <div class="mb-6">
        <p class="text-[30px] font-bold mt-1 flex items-center">${
          wordData.word
        } (   <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 cursor-pointer hover:text-violet-600 pronunciation-icon" width="31" height="31" viewBox="0 0 31 31" fill="none" data-pronunciation="${
...
</svg> :  ${wordData.pronunciation}  )</p>
      </div>
      
      <div class="space-y-4">
        <div>
          <p class="font-medium text-gray-700">Meaning:</p>
          <p class="text-lg bangla-font">${
            wordData.meaning == null ? "No meaning available" : wordData.meaning
          }</p>
        </div>
